...
def test_list(STREAM_ARRAY_SIZE):
    ...
    times[0] = timer()
    list_copy = cythonfn.copy_test(a_list, c_list, STREAM_ARRAY_SIZE)
    # for j in range(STREAM_ARRAY_SIZE):
    #    c_list[j] = a_list[j]
    ...
    # scale
    times[1] = timer()
    list_scale = cythonfn.scale_test(b_list, c_list, scalar, STREAM_ARRAY_SIZE)
    # for j in range(STREAM_ARRAY_SIZE):
    ...
    # sum
    times[2] = timer()
    list_sum = cythonfn.sum_test(a_list, b_list, c_list, scalar, STREAM_ARRAY_SIZE)
    # for j in range(STREAM_ARRAY_SIZE):
    ...
    # triad
    times[3] = timer()
    list_triad = cythonfn.traid_test(a_list, b_list, c_list, scalar, STREAM_ARRAY_SIZE)
    # for j in range(STREAM_ARRAY_SIZE):
...
def test_array(STREAM_ARRAY_SIZE):
    ...
    # scale
    times[1] = timer()
    array_scale = cythonfn.scale_test(b_array, c_array, scalar, STREAM_ARRAY_SIZE)
    for i in b_array:
        i = i * scalar
    times[1] = timer() - times[1]
    # sum
    ...
    # triad
    times[3] = timer()
    array_triad = cythonfn.triad_test(a_array, b_array, c_array, scalar, STREAM_ARRAY_SIZE)
    # for j in range(STREAM_ARRAY_SIZE):
